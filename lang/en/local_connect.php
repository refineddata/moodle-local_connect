...
/**
 * Strings for component 'local_connect', language 'en'
 *
 ...
 */
$string['local_connect']               = 'Connect';
$string['pluginname']               = 'Connect';
$string['pluginadministration']     = 'Connect';
// Settings
$string['settings'] = 'Connect';

$string['general'] = 'General';

$string['connect_meeting_duration'] = 'Meeting Duration';
$string['connect_meeting_duration_help'] = 'Meeting Duration';

// copy from mod connect
$string['pluginadministration'] = 'Connect administration';
...
<p><a target="_blank" href="http://rds.adobeconnect.com/connectmeeting/">More information about Connect Meetings</a>.</p>
';
...
$string['connectcron'] = 'Mod Connect Cron';
...
$string['connect:addinstance'] = 'Add connect activity';
...
$string['override_password'] = 'Override AC password on existing accounts';
$string['override_password_description'] = 'By enabling this setting, accounts that exist in Adobe Connect prior to being created in the LMS will have their AC password reset, if required, to be effectively synced with Refined Services.';
